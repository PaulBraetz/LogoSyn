...
namespace RhoMicro.LogoSyn.Libs.Dom.Dom;
...
internal sealed class Chunk<TDiscriminator> : IEquatable<Chunk<TDiscriminator>?>, IEnumerable<IDomElement<TDiscriminator>>
{
	...
	public override Boolean Equals(Object? obj) => Equals(obj as Chunk<TDiscriminator>);
	...
	public IEnumerator<IDomElement<TDiscriminator>> GetEnumerator() => _elements.OrderBy(e => e, DomElementComparer<TDiscriminator>.Instance).GetEnumerator();
