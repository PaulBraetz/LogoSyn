...
public struct StringSlice : IEquatable<IStringSlice>, IStringSlice
{
	...
	/// <inheritdoc/>
	public override Boolean Equals(Object? obj) => obj is IStringSlice slice && Equals(slice);

	/// <inheritdoc/>
	public Boolean Equals(IStringSlice? other) => StringSliceEqualityComparer.Instance.Equals(this, other);

	/// <inheritdoc/>
	public override Int32 GetHashCode() => StringSliceEqualityComparer.Instance.GetHashCode(this);
	...
	/// <inheritdoc/>
	public static Boolean operator ==(StringSlice left, StringSlice right) => left.Equals(right);

	/// <inheritdoc/>
	public static Boolean operator !=(StringSlice left, StringSlice right) => !(left == right);
}
