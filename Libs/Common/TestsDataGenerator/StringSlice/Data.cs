...
namespace RhoMicro.LogoSyn.Libs.Common.Tests.TestsDataGenerator.StringSlice
{
	internal class Data : IData
	{
		...
		private static IEnumerable<(String value, Int32 start, Int32 length)> InvalidSlices(Int32 count)
		{
			...
			IEnumerable<(String value, Int32 start, Int32 length)> invalidate((String value, Int32 start) t)
			{
		...
		private static IEnumerable<Object[]> InvalidSlices_Value(Int32 count)
		{
		...
		private static IEnumerable<String> GetPropertyDeclarations(Int32 count)
		{
			return new String[]
			{
				...
				GetPropertyDeclaration(InvalidSlices_Value(count), nameof(InvalidSlices_Value)),
				...
				GetPropertyDeclaration(InvalidSlices_Value(count), "InvalidReSlices_Value"),
		...
		private static String GetClassDeclaration(Int32 count)
		{
			return $"namespace RhoMicro.LogoSyn.Libs.Common.Tests{{public static class Data{{{String.Join("", GetPropertyDeclarations(count))}}}}}";
		}
